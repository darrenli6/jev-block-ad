...
async function init(): Promise<void> {
  ...
  const hideEffect = $<HTMLSelectElement>("hideEffect");
  hideEffect.value = s.hideEffect ?? "fireworks";
  hideEffect.onchange = () => void saveSettings({ hideEffect: hideEffect.value as Settings["hideEffect"] });
